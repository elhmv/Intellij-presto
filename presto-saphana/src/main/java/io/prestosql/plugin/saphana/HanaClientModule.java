        ...
        implements Module
{
    ...
    {
        binder.bind(JdbcClient.class).annotatedWith(ForBaseJdbc.class).to(HanaClient.class).in(Scopes.SINGLETON);
    ...
    @Singleton
    @ForBaseJdbc
    public ConnectionFactory createConnectionFactory(BaseJdbcConfig config, CredentialProvider credentialProvider)
    {
