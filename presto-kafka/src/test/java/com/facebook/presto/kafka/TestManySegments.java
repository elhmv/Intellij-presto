...
public class TestManySegments
{
            ...
            throws Exception
    {
        ...
        embeddedKafka.createTopics(1, 1, createTopicsOptions, topicName);
        ...
        try (CloseableProducer<Long, Object> producer = embeddedKafka.createProducer()) {
            ...
            for (long i = 0; i < iMax; i++) {
                ...
                for (long j = 0; j < jMax; j++) {
                    producer.send(new ProducerRecord<Long, Object>(topicName, i, ImmutableMap.of("id", Long.toString(i * iMax + j), "value", UUID.randomUUID().toString())));
                }
            }
        }
    }
