...
public class TestMinimalFunctionality
{
            ...
            throws Exception
    {
        ...
        embeddedKafka.createTopics(2, 1, createTopicsOptions, topicName);
    ...
    private void createMessages(String topicName, int count)
    {
        try (CloseableProducer<Long, Object> producer = embeddedKafka.createProducer()) {
            for (long i = 0; i < count; i++) {
                ...
                producer.send(new ProducerRecord<>(topicName, i, message));
            }
        }
    }
    ...
    public void testTopicExists()
    {
        ...
        transaction(queryRunner.getTransactionManager(), (AccessControl) new AllowAllAccessControl())
                .singleStatement()
    ...
    private void assertEquals(MaterializedResult result, MaterializedResult expected) {
    }
}
